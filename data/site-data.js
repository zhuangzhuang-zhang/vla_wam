window.PAPERS_SITE_DATA = {
  "generatedAt": "2026-06-09T02:40:25.528790+00:00",
  ...
  "archives": [
    {
      ...
      "generatedAt": "2026-06-09T02:40:25.528652+00:00",
      "sourceMode": "strict",
      ...
      "papers": [
        {
          ...
          "summaryCn": "MotionWAM提出一个实时世界动作模型，通过单目相机和统一动作空间实现人形机器人的自主移动操作。采用三阶段训练逐步适应视觉动态和机器人本体，在多项真实任务中显著优于VLA基线。",
          "reasonCn": "该论文提出了一种基于视频世界模型特征的实时世界动作模型（WAM），用于驱动机器人全身运动，符合WAM标准。",
          "lane": "WAM",
        ...
        },
        {
          ...
          "summaryCn": "C$^3$ache提出一种免训练方法，通过缓存跨推理块的残差来加速WAM的推理过程。在Fast-WAM上实现高达2.5倍加速，且几乎不降低任务成功率。",
          "reasonCn": "该论文针对世界动作模型（WAM）的推理效率问题进行加速，属于WAM相关技术。",
          "lane": "WAM",
        ...
        },
        {
          ...
          "summaryCn": "ReCoVLA利用VLM推断故障模式并编译结构化奖励，为冻结的VLA策略训练残差恢复策略。实现了零样本虚实迁移，在仿真和真实实验中显著提升成功率。",
          "reasonCn": "该论文针对视觉-语言-动作（VLA）策略的故障恢复提出框架，直接改进VLA。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "TORL-VLA通过触觉衍生的力觉感知VLA预测参考动作，并结合在线RL进行在线适应。引入干预审查机制稳定训练，在长时程接触丰富任务上提升了成功率。",
          "reasonCn": "该论文提出一个结合触觉反馈和在线强化学习的VLA框架，用于接触丰富的操作任务。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "B2FF在执行前生成熟悉未来状态的里程碑库，在故障时选择可恢复的里程碑作为固定视觉目标，引导VLA回到熟悉状态。无需微调，在LIBERO上成功提升恢复率。",
          "reasonCn": "该论文提出一种针对VLA策略的故障恢复方法，利用预想象未来状态引导恢复。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "SyVLA采用意图解耦算法和相似样本引导的RL训练，提高了现实世界任务成功率与分布外泛化能力，同时保持视觉语言核心能力。",
          "reasonCn": "该论文提出一种通过多样化经验训练的鲁棒VLA模型，属于VLA方法。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summary": "World models have recently seen a rapid growth in both their popularity and capability as more data efficient tools for generating robot training data or simulating real world environments, with many works proposing their integration into the robot learning pipeline. While highly practical, in this work we demonstrate that world models introduce a uniquely stealthy and effective data poisoning entry point into the robot learning supply chain that can result in the deployment of unsafe or otherwise compromised robo…",
          "summaryCn": "论文提出一种针对世界模型的数据投毒攻击，可在看似安全的数据中注入恶意提示，生成危险轨迹并毒害下游策略。在DRL和VLA场景下验证了攻击有效性，呼吁研究更安全的世界模型。",
          "reasonCn": "该论文揭示了世界模型在机器人学习中的安全漏洞，攻击会通过世界模型影响下游VLA策略，同时涉及WAM和VLA。",
          "lane": "BOTH",
        ...
        },
        {
          ...
          "summaryCn": "ATM通过动作一致性转移矩阵评估隐式世界模型在规划中的表示质量，无需昂贵仿真即可快速筛选检查点。进一步利用动作可辨识性作为训练信号改进下游规划。",
          "reasonCn": "该论文提出用于诊断和改进隐式世界模型的矩阵，以辅助规划，聚焦世界模型的动作一致性。",
          "lane": "WAM",
        ...
        },
        {
          ...
          "summaryCn": "ω-EVA构建动作条件隐动态，通过世界模型反馈优化策略提议的动作块。在多种仿真设置中持续改进基政策，展示了世界模型作为主动反馈模块的价值。",
          "reasonCn": "该论文提出一个隐式交互世界模型，用于具身动作生成，实现构想-验证-行动循环。",
          "lane": "WAM",
        ...
        },
        {
          ...
          "summaryCn": "FF-JEPA引入动作无关的隐式规划器，将长时域任务分解为短时域优化子问题，无需目标图像。在PushT上克服了平坦世界模型的长时域崩塌。",
          "reasonCn": "该论文利用JEPA世界模型进行长时域规划，提出分层方法，符合WAM标准。",
          "lane": "WAM",
    ...
    },
    {
      ...
      "generatedAt": "2026-06-09T02:38:30.239935+00:00",
      "sourceMode": "strict",
      "sourceNoteCn": "严格窗口：使用前一天 08:00 到当天 08:00 的 VLA / WAM 论文。",
      "papers": [
        {
          ...
          "summaryCn": "提出一个统一推理运行时vla.cpp，支持多种VLA架构在资源受限硬件上高效部署，并通过计算束缚分析和优化显著降低延迟。",
          "reasonCn": "论文提出统一推理运行时以高效部署VLA模型，直接涉及视觉、语言和动作处理。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "提出轻量级世界动作模型Light-WAM，通过潜在空间视频监督和状态融合动作专家实现高效机器人操控，在低参数和低延迟下保持高性能。",
          "reasonCn": "论文提出轻量级世界动作模型Light-WAM，明确以未来视频监督和动作预测为核心实现高效机器人操控。",
          "lane": "WAM",
        ...
        },
        {
          ...
          "summaryCn": "提出Q-VGM方法，通过价值梯度匹配微调流匹配VLA策略，避免反向传播不稳定，有效利用Q函数改进动作预测。",
          "reasonCn": "论文提出Q-VGM方法微调流匹配VLA策略，直接涉及视觉、语言和动作的端到端优化。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "提出MotionVLA，将运动一致性注入VLA模型，通过轨迹场令牌改善长时程操作，提高执行平滑性。",
          "reasonCn": "论文提出MotionVLA将运动一致性注入VLA模型，直接处理视觉输入和语言指令以生成更稳定的动作。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "研究利用第一人称人类数据微调VLA模型，使机器人学习新任务语义和组合技能，解决数据稀缺问题。",
          "reasonCn": "论文研究利用第一人称人类数据微调VLA模型，直接涉及视觉-语言-动作的迁移学习。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "提出PRISM框架，从世界模型自身提取动作先验，通过精度加权融合指导规划采样，提高模型基控制效率。",
          "reasonCn": "论文提出PRISM框架从世界模型提取动作先验用于规划，明确将世界模型用于动作选择。",
          "lane": "WAM",
    ...
    },
    {
      ...
      "generatedAt": "2026-06-09T02:37:37.083537+00:00",
      "sourceMode": "strict",
      "sourceNoteCn": "严格窗口：使用前一天 08:00 到当天 08:00 的 VLA / WAM 论文。",
      "papers": [
        {
          ...
          "summaryCn": "TBD-VLA通过将动作序列划分为时间块并在块内进行掩蔽离散扩散，统一了自回归生成与并行解码。在仿真和真实操作任务中显著优于先前VLA方法，提供了快速且时间一致的动作生成方案。",
          "reasonCn": "提出基于分块扩散的离散VLA模型，实现高效时序动作生成。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "title": "LARA: Latent Action Representation Alignment for Vision-Language-Action Models",
          "summary": "Visual-language action (VLA) models enable robots to predict actions directly from observations and language instructions, but their performance depends on large-scale, high-quality data and is limited by the scarcity of real-world robot action datasets. To facilitate VLA model learning with abundant unlabeled human videos, Latent Action Models (LAM) learn latent action representations from visual dynamics to provide additional supervision for VLA learning. However, LAM and VLA are typically trained separately, le…",
          "summaryCn": "LARA通过表示对齐使潜在动作模型与VLA相互增强，减轻幻觉并利用人类视频数据。在多个操作基准上实现显著提升，展示了其在预训练、增强和细化方面的灵活性和有效性。",
          "reasonCn": "提出LARA框架联合优化VLA和潜在动作模型，提升机器人操作性能。",
          "lane": "VLA",
          "link": "https://arxiv.org/abs/2606.07100v1",
          "pdfLink": "https://arxiv.org/pdf/2606.07100v1",
          "published": "2026-06-05T09:51:25Z",
        ...
        },
        {
          ...
          "title": "Coarse-to-Control: Action-Token Planning for Vision-Language-Action Models",
          "summary": "Most vision-language-action (VLA) models map observations directly to actions without explicit intermediate planning, which limits performance on long-horizon tasks where early mistakes compound. We propose Coarse-to-Control, a plan-execute VLA that introduces planning natively in the action-token space. The key idea is to let the policy first predict a compact sequence of coarse action tokens that summarize the intended future trajectory, and then generate executable action tokens conditioned on this plan.",
          "summaryCn": "Coarse-to-Control引入动作标记规划，先预测粗粒度动作序列再生成可执行动作。在LIBERO、SimplerEnv和真实操作中均表现出优于直接动作生成的效果，尤其擅长长程序列任务。",
          "reasonCn": "提出在VLA动作标记空间中进行规划的方法，提升长程任务性能。",
          "lane": "VLA",
          "link": "https://arxiv.org/abs/2606.07107v1",
          "pdfLink": "https://arxiv.org/pdf/2606.07107v1",
          "published": "2026-06-05T10:01:37Z",
        ...
        },
        {
          ...
          "summaryCn": "AdaWAM观察到世界动作模型在不同执行阶段需要不同推理模式，通过轻量动态路由器实现文本与视觉推理的自适应切换。在仿真和真实具身任务上提高了推理效率，并优于最先进的策略。",
          "reasonCn": "提出自适应多模态推理的世界动作模型AdaWAM，提升复杂任务效率与性能。",
          "lane": "WAM",
        ...
        },
        {
          ...
          "summaryCn": "通过统一探针评估多种编码器，发现时序视频预训练比像素重建更能诱导动作相关表示。在CALVIN等基准上验证，为设计更鲁棒的视觉运动模型提供了依据。",
          "reasonCn": "研究视频世界模型潜在空间中动作相关结构的来源，指导机器人动作预测。",
          "lane": "WAM",
        ...
        },
        {
          ...
          "summaryCn": "FLIGHT VLA采用异步架构，将低频流式视觉语言模型用于任务状态推理，高频扩散动作模型用于连续控制。在FLIGHT基准上表现优异，可实时执行复杂指令。",
          "reasonCn": "提出面向细粒度长程UAV导航的VLA模型，结合流式推理与扩散动作模型。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "WIZARD仅凭语言指令和演示视频预测任务特定的LoRA参数，立即适应新任务。在LIBERO和Franka机器人上显著提升性能，展示了跨任务的泛化能力。",
          "reasonCn": "提出基于权重空间元学习的VLA策略快速适应方法，无需任务特定微调。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "ActionMap用体素热图预测连续动作的概率分布，替代传统单点预测头。在多种骨干网和任务上表现一致提升，数据效率更高，为VLA动作解码提供了新范式。",
          "reasonCn": "提出体素热图动作解码器，改进VLA动作表示的几何结构利用。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "RhinoVLA采用令牌高效骨干和连续动作专家，结合统一机器人接口，在Huixi R1边缘芯片上实现11.69Hz推理。性能与π0.5相当，满足实时闭环控制需求。",
          "reasonCn": "提出面向边缘部署的高效VLA模型，通过令牌优化和硬件感知编译实现实时控制。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "STRIPS-WM从图像变换中学习潜在谓词和命题操作符，形成可规划的动作模型。在视觉重组任务上验证了从高维图像中提取经典规划符号的有效性。",
          "reasonCn": "提出从图像中学习STRIPS风格世界模型的框架，直接用于行动规划。",
          "lane": "WAM",
    ...
    },
    {
      ...
      "generatedAt": "2026-06-09T02:36:00.685020+00:00",
      "sourceMode": "strict",
      "sourceNoteCn": "严格窗口：使用前一天 08:00 到当天 08:00 的 VLA / WAM 论文。",
      "papers": [
        {
          ...
          "title": "World-Language-Action Model for Unified World Modeling, Language Reasoning, and Action Synthesis",
          "summary": "We propose world-language-action (WLA) models as a new class of embodied foundation models. WLA takes textual instructions, images, and robot states as inputs to jointly predict textual subtasks, subgoal images, and robot actions, conjoining the \\emph{world modeling interface} to learn from extensive egocentric videos as in the world-action model (WAM) and the \\emph{language reasoning} capacities to solve complex long-horizon tasks as in vision-language-action (VLA) models. At the core of WLA lies an \\emph{autoreg…",
          "summaryCn": "提出WLA模型作为具身基础模型，将世界建模与语言推理结合，通过自回归Transformer预测下一状态（文本意图与物理动态），并利用世界专家与动作专家进行训练，实现机器人动作合成。在模拟与真实环境中验证了有效性。",
          "reasonCn": "该论文提出世界-语言-动作（WLA）模型，同时结合世界模型与视觉-语言-动作能力，用于统一的世界建模、语言推理和动作生成。",
          "lane": "BOTH",
          "link": "https://arxiv.org/abs/2606.05979v1",
          "pdfLink": "https://arxiv.org/pdf/2606.05979v1",
          "published": "2026-06-04T10:23:01Z",
        ...
        },
        {
          ...
          "title": "PiL-World: A Chunk-Wise World Model for VLA Policy-in-the-Loop Evaluation",
          "summary": "Vision-language-action (VLA) policies operate in a closed loop in real-world robot tasks: a robot observes the scene, executes an action chunk, and conditions its next decision on the resulting observation. However, most existing world models for robot action evaluation are limited to open-loop prediction along pre-collected action trajectories. This prevents them from supporting closed-loop VLA evaluation, where each action chunk must be conditioned on the observation generated by the previous execution.",
          "summaryCn": "提出分块世界模型PiL-World，通过交替VLA推理与世界模型预测实现在无实际机器人执行下的闭环评估。模型利用动作导出的视觉控制和潜在历史，提升滚动保真度，并可从失败轨迹学习。",
          "reasonCn": "该论文提出PiL-World，一种分块世界模型，专为VLA策略的闭环评估设计，生成与动作序列一致的未来观察，用于动作评估。",
          "lane": "WAM",
          "link": "https://arxiv.org/abs/2606.05773v1",
          "pdfLink": "https://arxiv.org/pdf/2606.05773v1",
          "published": "2026-06-04T06:57:25Z",
        ...
        },
        {
          ...
          "title": "WorldFly: A World-Model-Based Vision-Language-Action Model for UAV Navigation",
          "summary": "End-to-end Vision-Language-Action (VLA) models have shown promise in UAV navigation. However, existing approaches typically rely on historical observations to directly predict actions, often struggling in dense urban environments where severe occlusions and sharp turns result in drastic viewpoint transitions. We argue that the ability to \"imagine\" future states -- inherent in World Models -- is critical for robust decision-making under such partial observability.",
          "summaryCn": "构建城市峡谷穿越基准，提出WorldFly框架，采用双分支耦合流匹配机制，通过空间想象引导动作规划。实验表明WorldFly在不可见环境中优于基线，验证了世界模型与VLA结合的有效性。",
          "reasonCn": "该论文提出WorldFly，一种基于世界模型的VLA框架，联合生成未来视频预测和导航动作，用于无人机导航。",
          "lane": "BOTH",
          "link": "https://arxiv.org/abs/2606.06147v1",
          "pdfLink": "https://arxiv.org/pdf/2606.06147v1",
          "published": "2026-06-04T13:23:05Z",
        ...
        },
        {
          ...
          "title": "Let It Be Simple: One-Step Action Generation for Vision-Language-Action Models",
          "summary": "Diffusion-based vision-language-action (VLA) models often inherit the image-generation view: actions are generated by iterative denoising. We argue that VLA action generation has a different condition-target structure: the policy is conditioned on rich observations, language, and state, but predicts only a compact, low-dimensional action chunk. Under this asymmetry, strong one-step action generation should not necessarily require the advanced one-step methods developed for image synthesis.",
          "summaryCn": "针对扩散VLA模型，通过简单的高噪声偏置训练，实现与多步解码相当的一步动作生成。在LIBERO基准和真实双臂机器人上验证，1.4B模型一步解码达到95.6%成功率。",
          "reasonCn": "该论文专注于VLA模型的动作生成，提出通过训练时噪声分布偏置实现一步动作解码，无需引入教师模型或蒸馏。",
          "lane": "VLA",
          "link": "https://arxiv.org/abs/2606.05737v1",
          "pdfLink": "https://arxiv.org/pdf/2606.05737v1",
          "published": "2026-06-04T05:58:30Z",
        ...
        },
        {
          ...
          "title": "Discrete-WAM: Unified Discrete Vision-Action Token Editing for World-Policy Learning",
          "summary": "Autonomous driving requires reasoning about how ego actions shape the evolution of the surrounding world. However, most end-to-end methods rely on direct state-to-action mappings, capturing correlations without explicitly modeling action-conditioned dynamics. Conversely, continuous-latent world models often lack compositional structure for causal reasoning across counterfactual futures.",
          "summaryCn": "将未来视觉状态和自车动作表示为对齐的离散token，建立共享离散扩散框架，联合世界建模、世界-动作策略和分层决策。在大规模自动驾驶基准上取得竞争性能，支持可控生成与反事实推理。",
          "reasonCn": "该论文提出Discrete-WAM，一个统一的离散视觉-动作世界策略，显式建模动作条件化动态，并支持因果推理与分层决策。",
          "lane": "WAM",
          "link": "https://arxiv.org/abs/2606.05645v1",
          "pdfLink": "https://arxiv.org/pdf/2606.05645v1",
          "published": "2026-06-04T03:16:31Z",
        ...
        },
        {
          ...
          "title": "TempoVLA: Learning Speed-Controllable Vision-Language-Action Policies",
          "summary": "Robot manipulation alternates between low-risk transit phases that call for fast execution and high-risk contact stages that demand slow, precise motion. Yet existing Vision-Language-Action models (VLAs) only inherit a single fixed speed from training demonstrations. Prior efforts to accelerate VLAs through model compression, KV-cache reuse, or reinforcement learning only shift the policy from one fixed speed to another, and leave deceleration almost unexplored.",
          "summaryCn": "观察到动作幅值可调控机器人速度，提出速度条件VLA。通过变速度轨迹增强和模型条件机制，实现加速和减速控制，同时提升默认速度性能。仿真与真实实验验证灵活性。",
          "reasonCn": "该论文提出TempoVLA，一种速度可控的视觉-语言-动作策略，通过速度条件控制实现可变执行速度。",
          "lane": "VLA",
          "link": "https://arxiv.org/abs/2606.06491v1",
          "pdfLink": "https://arxiv.org/pdf/2606.06491v1",
          "published": "2026-06-04T17:59:40Z",
        ...
        },
        {
          ...
          "title": "MPCoT: Reward-Guided Multi-Path Latent Reasoning for Test-Time Scalable Vision-Language-Action",
          "summary": "Vision-Language-Action (VLA) policies remain brittle in long-horizon and high-uncertainty control, where one-pass action decoding provides limited inference-time deliberation. Explicit chain-of-thought can increase reasoning depth, but introduces token latency and an indirect text-to-action interface. We propose MPCoT, a reward-guided multi-path latent reasoning framework that initializes $M$ hypotheses, refines them for K weight-tied steps, and softly aggregates them before action decoding.",
          "summaryCn": "通过多假设初始化、权重绑定迭代精炼与软聚合，实现不产生额外推理token的测试时可扩展VLA。利用专家动作一致性、世界模型/VLM进度和成功反馈训练路径评分器，在LIBERO和CALVIN上改进长程性能。",
          "reasonCn": "该论文提出MPCoT，一种奖励引导的多路径潜在推理框架，提升VLA在长时序高不确定性控制中的测试时性能。",
          "lane": "VLA",
          "link": "https://arxiv.org/abs/2606.06245v1",
          "pdfLink": "https://arxiv.org/pdf/2606.06245v1",
          "published": "2026-06-04T14:48:44Z",
        ...
        },
        {
          ...
          "summaryCn": "引入Which2Act、Where2Act、How2Act三个组件，渐进建模物体定位、2D交互点和3D几何推理。采用混合Transformer架构和渐进数据课程，克服affordance标签稀缺问题，在操作任务上提升鲁棒性。",
          "reasonCn": "该论文提出AffordanceVLA，通过affordance预测作为感知-动作映射的中间表示，增强VLA的操作精确性。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "针对双手灵巧工具使用，设计未来状态视觉运动目标预测器，基于历史生成多步目标轨迹，低层策略跟踪执行。在OakInk2上达90%特权先知性能，无需在线规划，60Hz频率运行。",
          "reasonCn": "该论文提出DexFuture，一个分层系统，高层预测未来视觉运动状态作为世界模型，低层跟踪实现灵巧操作，核心是世界模型用于动作规划。",
          "lane": "WAM",
        ...
        },
        {
          ...
          "summaryCn": "PLAN-S从潜在世界模型解码四通道语义代价图，结合自我状态和驾驶风格，通过注意力或奖励融合注入规划器。在nuScenes和NAVSIM上降低碰撞率，提升规划PDMS。",
          "reasonCn": "该论文提出PLAN-S，为自动驾驶世界模型引入风格条件代价图，衔接规划与控制，明确用于动作决策。",
          "lane": "WAM",
        ...
        },
        {
          ...
          "summaryCn": "研究工业物流具身智能的数据飞轮，提出WM-DAgger利用世界模型合成分布外恢复数据以提升模仿学习。框架将操作数据转化为持续策略改进，是典型的世界模型在动作控制中的应用。",
          "reasonCn": "该论文提出物流数据飞轮框架，核心基于世界模型为长尾包裹操作生成可靠监督，用于策略改进。",
          "lane": "WAM",
    ...
    },
    {
      ...
      "generatedAt": "2026-06-09T02:34:07.845849+00:00",
      "sourceMode": "strict",
      "sourceNoteCn": "严格窗口：使用前一天 08:00 到当天 08:00 的 VLA / WAM 论文。",
      "papers": [
        {
          ...
          "title": "Flash-WAM: Modality-Aware Distillation for World Action Models",
          "summary": "World-action models (WAMs) jointly generate future video and robot actions through iterative diffusion, achieving strong performance on manipulation benchmarks but requiring tens of denoising steps, a cost that precludes real-time control. Step distillation has emerged as the natural remedy, but off-the-shelf methods break down in the joint video-action setting because video and action streams use different SNR-shifted noise schedules and reach training with substantially different marginal noise distributions, an…",
          "summaryCn": "提出Flash-WAM，通过一致性蒸馏分别处理视频和动作流的不同噪声特性，将推理压缩到单步，实现23倍加速，在保持任务性能的同时达到实时控制。",
          "reasonCn": "该论文提出模态感知蒸馏框架加速世界动作模型推理，直接生成视频和动作，符合WAM。",
          "lane": "WAM",
          "link": "https://arxiv.org/abs/2606.05254v1",
          "pdfLink": "https://arxiv.org/pdf/2606.05254v1",
          "published": "2026-06-03T15:29:57Z",
        ...
        },
        {
          ...
          "title": "OSCAR: Omni-Embodiment Action-Conditioned World Model for Robotics",
          "summary": "We present OSCAR, a precise action-conditioned video world model that generalizes across different robot embodiments and enables robot policy evaluation. Existing video world models face three main challenges for real-world robot evaluation: limited scenario diversity in current robot training datasets, imprecise action following, and poor generalization across embodiments for broad adoption. We tackle these challenges from two perspectives.",
          "summaryCn": "OSCAR是一种动作条件视频世界模型，能跨机器人形态泛化，使用2D骨架渲染统一条件表征，在单个GPU上微调Cosmos模型，实现高质量动作跟随和外观质量，可用于机器人策略虚拟评估。",
          "reasonCn": "该论文提出动作条件视频世界模型，用于机器人策略评估，符合WAM标准。",
          "lane": "WAM",
          "link": "https://arxiv.org/abs/2606.04463v2",
          "pdfLink": "https://arxiv.org/pdf/2606.04463v2",
          "published": "2026-06-03T05:16:41Z",
        ...
        },
        {
          ...
          "title": "VISTA: Vision-Grounded and Physics-Validated Adaptation of UMI data for VLA Training",
          "summary": "Universal Manipulation Interface (UMI) enables scalable real-world robot data collection without hardware-specific teleoperation, yet leveraging UMI data to train large-scale Vision-Language-Action (VLA) models remains fundamentally challenging. We identify two critical mismatches: wrist-mounted fisheye views, with severe radial distortion and local gripper-centric perspectives, are out-of-distribution for pretrained VLMs; and human-collected trajectories frequently violate kinematic limits, incur collisions, or e…",
          "summaryCn": "提出VISTA框架，通过UMI-VQA数据集、物理验证管道和两阶段协同训练，解决UMI数据用于VLA训练时的视觉域外分布和动作物理可行性问题，提升策略性能。",
          "reasonCn": "该论文针对VLA训练中UMI数据的视觉和物理有效性挑战提出解决方案，直接涉及视觉-语言-动作模型。",
          "lane": "VLA",
          "link": "https://arxiv.org/abs/2606.04708v2",
          "pdfLink": "https://arxiv.org/pdf/2606.04708v2",
          "published": "2026-06-03T10:38:45Z",
        ...
        },
        {
          ...
          "title": "3DThinkVLA: Endowing Vision-Language-Action Models with Latent 3D Priors via 3D-Thinking-Guided Co-training",
          "summary": "We propose a 3D-thinking-guided co-training framework that enables vision-language-action (VLA) models to perform 3D spatial reasoning implicitly during action prediction. Our core insight is that 3D geometry perception and 3D spatial reasoning are distinct capabilities that can be disentangled and injected at different feature hierarchies. During training, three tightly coupled components work in concert primarily within the latent space: (1) To gain geometric priors, a latent 3D geometry perception module aligns…",
          "summaryCn": "提出3DThinkVLA框架，解耦3D几何感知与空间推理，利用隐式3D先验和在线蒸馏，在不产生思维链文本的情况下增强VLA的动作预测空间推理能力。",
          "reasonCn": "该论文通过3D思维引导的协同训练赋予VLA模型隐式3D空间推理能力，属于VLA方向。",
          "lane": "VLA",
          "link": "https://arxiv.org/abs/2606.04436v1",
          "pdfLink": "https://arxiv.org/pdf/2606.04436v1",
          "published": "2026-06-03T04:34:07Z",
        ...
        },
        {
          ...
          "summaryCn": "提出ForesightFlow，一种自引导流匹配VLA策略，通过解耦优势加权流匹配训练成功潜能，实现无需外部评价的best-of-K推理，在仿真和真实任务中取得最高成功率。",
          "reasonCn": "该论文针对VLA策略改进提出基于流匹配和成功潜能引导的方法，涉及视觉、语言和动作。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "MIRAGE框架从显式推理文本学习隐式推理表示，并结合生成世界模型目标预测未来界面，在移动设备操控任务中以更少token生成量达到与链式思维微调相当的性能，提升执行效率。",
          "reasonCn": "该论文利用生成式世界模型目标，将隐式推理与未来界面预测对齐，用于移动代理的动作决策，符合WAM定义。",
          "lane": "WAM",
        ...
        },
        {
          ...
          "summaryCn": "WAM-Nav采用非对称联合扩散Transformer，同时生成长期行为和短期视觉预测，通过双流上下文条件机制促进平滑轨迹生成，支持多种目标导航，提高了视觉导航的预见性和鲁棒性。",
          "reasonCn": "该论文明确提出了潜在世界-动作模型，用于联合学习导航动作和视觉预见，是典型的WAM。",
          "lane": "WAM",
        ...
        },
        {
          ...
          "summaryCn": "FlowPRO是一种无奖励的离线强化微调框架，通过RPRO偏好优化目标和干预-回退数据收集，有效避免奖励破解，在双手长期任务中超越基线，改善了VLA的真实部署可靠性。",
          "reasonCn": "该论文提出基于偏好优化的流匹配VLA模型后训练框架，直接优化动作输出，属VLA范畴。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "HapTile数据集整合指尖触觉和操作员触觉反馈，为VLA提供接触感知的机器人操控数据，涵盖日常技能任务，语言指令条件策略，填补了当前VLA数据集触觉缺失的空白。",
          "reasonCn": "该论文旨在构建包含视觉、触觉、语言和动作的数据集，用于接触丰富的模仿学习，符合VLA多模态定义。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "通过四旋翼导航任务，评估DreamerV3世界模型在不同环境随机性下的鲁棒性，发现SSL预训练阶段的泛化能力可预测真实迁移，识别离散潜变量大小和训练序列长度为关键因素，为现实部署提供指导。",
          "reasonCn": "该论文系统研究DreamerV3世界模型在四旋翼导航中的环境泛化，直接用于动作策略训练和真实飞行，符合WAM。",
          "lane": "WAM",
        ...
        },
        {
          ...
          "summaryCn": "MAD将世界模型与占据和可见性地图重建相结合，迫使潜在编码学习局部几何和运动历史，在视觉导航和竞速任务中提高成功率、速度和跨任务迁移能力，并实现可解释的地图预测。",
          "reasonCn": "该论文提出映射感知的世界模型，通过重建栅格地图学习几何感知的潜在状态，用于敏捷四旋翼飞行控制，符合WAM。",
          "lane": "WAM",
    ...
    },
    {
      ...
      "generatedAt": "2026-06-09T02:32:52.644953+00:00",
      "sourceMode": "strict",
      "sourceNoteCn": "严格窗口：使用前一天 08:00 到当天 08:00 的 VLA / WAM 论文。",
      "papers": [
        {
          ...
          "title": "GeoSem-WAM: Geometry- and Semantic-Aware World Action Models",
          "summary": "Recent World Action Models (WAMs) have demonstrated impressive capabilities in embodied decision-making. However, whether their effectiveness stems from explicit future imagination during inference or representation learning induced by predictive training remains an open question. Emerging evidence suggests the primary advantage lies in learning robust latent representations rather than generating future observations at test time.",
          "summaryCn": "提出几何与语义感知的世界-行动模型GeoSem-WAM，通过辅助预测分支增强潜在表示，提升动作预测准确性和鲁棒性。该模型在测试时无需显式未来滚动，保持高效推理。实验表明结构化监督显著提升了具身场景下的性能。",
          "reasonCn": "以世界模型为核心，明确用于动作预测和场景理解，属于世界-行动模型（WAM）。",
          "lane": "WAM",
          "link": "https://arxiv.org/abs/2606.03188v1",
          "pdfLink": "https://arxiv.org/pdf/2606.03188v1",
          "published": "2026-06-02T05:48:02Z",
        ...
        },
        {
          ...
          "title": "NVIDIA OmniDreams: Real-Time Generative World Model for Closed-Loop Autonomous Vehicle Simulation",
          "summary": "As autonomous vehicle capabilities advance, the safe evaluation of driving policies in long-tail scenarios remains a critical bottleneck. In closed-loop simulation, the driving policy model actively interacts with the environment, where its actions dynamically update the simulator state and directly influence the next set of generated sensor observations. While recent reconstruction-based neural simulators offer photorealism, they are fundamentally constrained by their initial captured data and struggle to general…",
          "summaryCn": "OmniDreams是一个基于扩散模型的生成式世界模型，可实时生成动作条件视频，用于自动驾驶策略的安全评估。它结合Cosmos先验和大规模驾驶数据训练，能合成极端天气等复杂场景，提供可扩展的闭环仿真环境。",
          "reasonCn": "提出生成式世界模型OmniDreams，以动作条件自回归生成视频，用于自动驾驶闭环仿真，直接涉及动作预测。",
          "lane": "WAM",
          "link": "https://arxiv.org/abs/2606.03159v1",
          "pdfLink": "https://arxiv.org/pdf/2606.03159v1",
          "published": "2026-06-02T05:11:05Z",
        ...
        },
        {
          ...
          "title": "TTT-VLA: Test-Time Latent Prompt Optimization for Vision-Language-Action Models",
          "summary": "Vision-Language-Action (VLA) models trained on large-scale data have made remarkable progress, but they remain vulnerable to distribution shifts at deployment time. Recent VLA models suggest that prompts can serve as an efficient interface for steering policy behavior, but existing prompt-based steering typically relies on external guidance. This raises a natural question: can test-time training (TTT) for VLA be achieved by optimizing a prompt, so that the steering interface itself can be learned and adapted from…",
          "summaryCn": "TTT-VLA提出一种测试时训练框架，通过潜在提示优化（LPO）在不修改策略的情况下适应新环境。该方法在单体和多体设置中均提高了任务成功率，且仅需修正少量关键决策，实用性强。",
          "reasonCn": "论文聚焦于视觉-语言-动作模型（VLA）的测试时训练，通过潜在提示优化适应分布偏移，直接改进VLA策略。",
          "lane": "VLA",
          "link": "https://arxiv.org/abs/2606.03127v1",
          "pdfLink": "https://arxiv.org/pdf/2606.03127v1",
          "published": "2026-06-02T04:10:39Z",
        ...
        },
        {
          ...
          "title": "CLAW: Learning Continuous Latent Action World Models via Adversarial Latent Regularization",
          "summary": "We introduce CLAW, a fully end-to-end self-supervised framework for learning a world model jointly with continuous latent action representations directly from action-free videos. Our approach leverages adversarial latent regularization and diffusion-based video generation to capture structured and semantically meaningful action representations while modeling rich, predictive environment dynamics, without relying on any action labels or annotations. By simultaneously training the Latent Action Model and world model…",
          "summaryCn": "CLAW是一种自监督框架，利用对抗正则化和扩散模型从视频中学习结构化潜在动作和世界动力学。它无需动作标注，即可提取语义动作表示，并在多种任务中实现从观察中的模仿学习和规划。",
          "reasonCn": "从无动作视频中联合学习世界模型与连续潜在动作，支持模仿学习和目标导向规划，属于世界-行动模型。",
          "lane": "WAM",
          "link": "https://arxiv.org/abs/2606.04130v1",
          "pdfLink": "https://arxiv.org/pdf/2606.04130v1",
          "published": "2026-06-02T18:40:24Z",
        ...
        },
        {
          ...
          "title": "PHASER: Phase-Aware and Semantic Experience Replay for Vision-Language-Action Models",
          "summary": "Vision-Language-Action (VLA) models have achieved remarkable success in language-conditioned robotic manipulation. However, deploying these models in open-ended environments requires continuously acquiring novel skills, a process that inevitably triggers severe catastrophic forgetting of previously learned behaviors. While experience replay (ER) serves as a standard mitigating strategy, naive uniform sampling fundamentally misaligns with the temporal characteristics of manipulation trajectories.",
          "summaryCn": "PHASER是一种架构无关的持续学习框架，通过相位中心容量分配和多模态干扰路由，解决VLA模型在新技能学习中的灾难性遗忘。它还引入自动相位检测，在无需人工监督的情况下实现终身自适应。",
          "reasonCn": "针对视觉-语言-动作模型的持续学习问题，提出相位感知经验回放，避免灾难性遗忘，直接改进VLA性能。",
          "lane": "VLA",
          "link": "https://arxiv.org/abs/2606.03598v2",
          "pdfLink": "https://arxiv.org/pdf/2606.03598v2",
          "published": "2026-06-02T13:04:15Z",
        ...
        },
        {
          ...
          "summaryCn": "该工作首次探索了VLA模型在部分可观测威胁下的对抗鲁棒性，提出两阶段攻击框架。通过注意力定位和补丁优化，它在模拟和真实环境中显著降低了任务成功率，揭示了VLA的安全隐患。",
          "reasonCn": "研究视觉-语言-动作模型在部分可观测条件下的对抗攻击，直接评估和改进VLA的鲁棒性。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "SceneDiver通过粗到细的焦点计划生成方法，缓解VLM/VLA的视觉幻觉问题。它先构建场景图，再迭代分解任务，并将专注能力蒸馏到VLA中，在标准基准上显著减少了幻觉。",
          "reasonCn": "提出利用视觉-语言模型规划能力生成焦点计划，并蒸馏到视觉-语言-动作模型中，提升VLA的感知能力。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "GeoAlign是一种状态引导的空间对齐架构，为VLA策略引入几何后训练和本体感受查询，生成相位依赖的几何令牌。它在LIBERO和真实ALOHA任务中取得了高成功率，证明了几何感知的价值。",
          "reasonCn": "提出GeoAlign架构，通过状态引导的空间对齐增强VLA策略的几何感知能力，直接改进动作预测。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "ERVLA通过推理遗忘策略将具身思维链用作表征监督，使VLA模型在训练时吸收推理痕迹，推理时直接预测动作。该方法在LIBERO-Plus上达到最优，且具有良好的扩展性。",
          "reasonCn": "构建最大规模具身思维链数据集并提出ERVLA模型，以表征塑造方式增强VLA性能，避免自回归推理的不稳定性。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "OpenEAI-Platform整合了低成本6+1自由度机械臂和基于Qwen3-VL-4B的VLA模型，在真实世界任务中表现媲美大规模预训练基线。全部硬件设计、模型和流水线将开源，推动可复现研究。",
          "reasonCn": "发布开源VLA平台OpenEAI，包含硬件和VLA模型，可直接用于实际操作任务。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "AirDreamer使用强化学习策略在世界模型上进行导航，无需手工设计感知管线，在未见环境中展现涌现能力。它在仿真和真实无人机上实现了零样本迁移，成功率和抗局部最优能力优于基线。",
          "reasonCn": "提出基于世界模型的无人机导航框架，利用世界模型理解环境并生成避障动作，实现鲁棒导航。",
          "lane": "WAM",
        ...
        },
        {
          ...
          "summaryCn": "该工作聚焦导航中可通行的几何，引入3D等视域作为预测目标，构建了具身世界模型。模型通过残差预测和自滚动训练保持几何一致性，并涌现出跨城市导航特征，为规划提供结构信息。",
          "reasonCn": "提出3D等视域世界模型，预测可导航几何，用于具身智能体的导航动作规划。",
          "lane": "WAM",
        ...
        },
        {
          ...
          "summaryCn": "该工作展示了等变编码器和预测器构建的世界模型具有精确群不变性，在训练后依然保持，从而实现零样本泛化。在PushT任务中，闭环控制误差在群上保持一致，且模型尺寸更小。",
          "reasonCn": "提出等变世界模型，通过群对称性实现零样本泛化，并用于控制任务，属于世界-行动模型。",
          "lane": "WAM",
        ...
        },
        {
          ...
          "summaryCn": "Donk将视频基础模型先验与机器人动作对齐，通过联合去噪生成未来视频和双手手部轨迹，既可作为动作策略，也可作为数据引擎。该统一训练配方在灵巧操作中提升了轨迹精度和视频保真度。",
          "reasonCn": "提出统一视频-动作联合去噪模型，用于灵巧手操作，同时生成手部轨迹和交互视频，属于世界-行动模型。",
          "lane": "WAM",
    ...
    },
    {
      ...
      "generatedAt": "2026-06-09T02:31:24.651541+00:00",
      "sourceMode": "strict",
      "sourceNoteCn": "严格窗口：使用前一天 08:00 到当天 08:00 的 VLA / WAM 论文。",
      "papers": [
        {
          ...
          "title": "WALL-WM: Carving World Action Modeling at the Event Joints",
          "summary": "WALL-WM is a World Action Model that shifts video-action learning from chunk-centric optimization to event-grounded Vision-Language-Action pretraining, using semantically coherent action events as the atomic unit of learning. Existing WAMs commonly initialize from multimodal or video foundation models and then optimize fixed-length action chunks conditioned directly on the current observation and instruction. Although convenient, this chunk-centric formulation creates a fundamental granularity mismatch.",
          "summaryCn": "WALL-WM 提出以语义事件为原子单元的世界动作模型，解决现有VLA的粒度不匹配问题，支持事件驱动和统一推理模式。",
          "reasonCn": "论文提出事件驱动的世界动作模型，同时涉及视觉输入、语言指令和机器人动作输出，且世界模型用于动作预测。",
          "lane": "BOTH",
          "link": "https://arxiv.org/abs/2606.01955v1",
          "pdfLink": "https://arxiv.org/pdf/2606.01955v1",
          "published": "2026-06-01T09:14:51Z",
        ...
        },
        {
          ...
          "title": "Intercepting the Future: Latent-Space Predictive World Model for Dynamic VLA Manipulation",
          "summary": "Vision-Language-Action (VLA) models generalize across static manipulation but fail when objects move during task execution. They map the current observation to an action and assume the scene is stationary between observation and execution, so at any non-trivial object speed the resulting latency exceeds the time available to grasp. We close this gap with AHEAD (Anticipatory Horizon Extrapolation with Adaptive Dynamics), a predict-then-act wrapper that augments a frozen VLA with a motion-aware latent world model.",
          "summaryCn": "AHEAD 提出预测-然后-动作的包装器，用潜在空间世界模型增强VLA，在动态操控任务中显著提高成功率。",
          "reasonCn": "论文为VLA模型增加预测性世界模型以处理动态物体，涉及视觉、语言和动作。",
          "lane": "BOTH",
          "link": "https://arxiv.org/abs/2606.02486v1",
          "pdfLink": "https://arxiv.org/pdf/2606.02486v1",
          "published": "2026-06-01T16:55:38Z",
        ...
        },
        {
          ...
          "summaryCn": "EG-GRPO通过专家引导的强化学习微调VLA模型，实现无人机精确意图对齐导航。",
          "reasonCn": "论文提出VLA无人机导航方法，涉及视觉输入、语言指令和动作控制。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "LDA在SE(3)流形上建模扩散策略，纠正VLA中的欧几里得谬误，提升操纵任务性能。",
          "reasonCn": "论文提出VLA扩散策略，在SE(3)上建模，涉及视觉、语言和机器人动作。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "S2通过细化语言和视觉证据预算改善VLA泛化，无需区域标注。",
          "reasonCn": "论文提出VLA泛化框架，通过视觉证据预算和语言细化改进动作预测。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "Cosmos 3 是统一多模态的世界模型，支持语言、图像、视频、音频和动作的联合处理与生成，为具身智能提供通用骨干。",
          "reasonCn": "论文提出多模态世界模型，明确用于动作生成，是Physical AI的核心。",
          "lane": "WAM",
        ...
        },
        {
          ...
          "summaryCn": "AURA-Mem 提出恒定大小的循环记忆，根据动作误差信号门控写入，优化VLA策略的带宽限制。",
          "reasonCn": "论文为VLA策略提出动作门控记忆，优化视觉、语言和动作的推理。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "SeeTraceAct 利用演示视频中的可见性预测实现跨形态的潜在规划，改善VLA策略的空间定位。",
          "reasonCn": "论文提出基于演示视频的VLA框架，涉及视觉、动作预测和机器人控制。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "MRO-GWM 学习动作条件的物体中心高斯泼溅世界模型，用于刚性物体的动力学预测和模型预测控制。",
          "reasonCn": "论文提出动作条件的世界模型，用于刚性物体动力学预测和模型预测控制。",
          "lane": "WAM",
        ...
        },
        {
          ...
          "summaryCn": "MetaWorld 从单视图视频扩展多智能体视频世界模型，实现一致的跨视图世界状态生成。",
          "reasonCn": "论文提出多智能体视频世界模型，通过动作控制生成一致的视图。",
          "lane": "WAM",
        ...
        },
        {
          ...
          "summaryCn": "提出利用自我中心人类行走视频与机器人演示共同训练VLA模型，提升移动机器人导航的语言理解和动作生成。",
          "reasonCn": "论文利用人类自我中心视频训练VLA导航模型，涉及视觉、语言和动作。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "RoboDream 通过组合式世界模型生成逼真的机器人演示，实现数据扩展，降低真实数据需求。",
          "reasonCn": "论文提出组合式世界模型，用于生成机器人演示数据，提升下游策略性能。",
          "lane": "WAM",
        ...
        },
        {
          ...
          "summaryCn": "GIM-World 提出几何感知的隐式记忆，增强视频世界模型的长程一致性，适用于可控视觉环境模拟。",
          "reasonCn": "论文提出视频世界模型的几何感知记忆，提升长程可控视觉模拟的一致性。",
          "lane": "WAM",
        ...
        },
        {
          ...
          "summaryCn": "SPAWN 提出训练自由的概念生成方法，使用户在交互式世界模型中指定视觉概念，增强可控性。",
          "reasonCn": "论文提出动作条件世界模型的概念生成方法，增强交互式视频生成的用户控制。",
          "lane": "WAM",
        ...
        },
        {
          ...
          "summaryCn": "IMWM 结合直觉模型和世界模型进行潜在规划，在多个目标达成任务中提升成功率。",
          "reasonCn": "论文提出直觉模型辅助世界模型进行潜在规划，用于像素输入的机器人控制。",
          "lane": "WAM",
        ...
        },
        {
          ...
          "summaryCn": "提出世界-任务因子分解，用可微图和学习策略实现机器人学习中的结构化泛化。",
          "reasonCn": "论文提出世界-任务因子分解，用分析世界模型和学习策略实现机器人控制。",
          "lane": "WAM",
        ...
        },
        {
          ...
          "summaryCn": "提出统一驾驶分词器，结合表征和几何引导，用于驾驶世界模型和规划。",
          "reasonCn": "论文提出用于驾驶世界模型和规划的分词器，涉及视觉和动作控制。",
          "lane": "WAM",
        ...
        },
        {
          ...
          "summaryCn": "TERRA 研究行动条件的潜在预测架构在跨域迁移中的性能，提供转移界限。",
          "reasonCn": "论文研究行动条件的潜在世界模型跨域迁移，涉及动作预测。",
          "lane": "WAM",
    ...
    },
    {
      ...
      "generatedAt": "2026-06-09T02:29:17.821939+00:00",
      "sourceMode": "strict",
      "sourceNoteCn": "严格窗口：使用前一天 08:00 到当天 08:00 的 VLA / WAM 论文。",
      "papers": [
        {
          ...
          "summaryCn": "提出模型无关的诊断框架，从行为展开和稀疏自编码器特征分析两个角度比较VLA与WAM。在LIBERO和RoboTwin2.0上评估了7种策略，揭示了任务成功以外的行为差异，如目标选择性和推理成本。为理解两类模型的内部表征与行为提供可操作的见解。",
          "reasonCn": "同时涉及VLA和WAM的行为与表征诊断，明确用于机器人操纵的动作分析。",
          "lane": "BOTH",
        ...
        },
        {
          ...
          "summaryCn": "针对低成本农业机械臂，实现了实时动作分块（RTAC）算法的系统级线程优化，降低端到端延迟。在蒜头、核桃等农产品操控任务中验证，提升了控制稳定性和速度。为VLA模型在低算力场景的部署提供了工程参考。",
          "reasonCn": "聚焦VLA模型在农业操控中的推理优化，涉及视觉输入、语言指令和动作输出。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "提出τ₀-WM，一个基于扩散的视频-动作世界模型，将策略学习、视频预测和动作评估统一在一个未来预测框架中。在大规模真实机器人数据上训练，推理时采用测试时计算进行候选动作采样、排序与纠正。在长时程精细操作任务中表现更优。",
          "reasonCn": "以统一视频-动作世界模型为核心，全部用于动作生成、评估与规划。",
          "lane": "WAM",
        ...
        },
        {
          ...
          "summaryCn": "提出MPVI框架，将基于模型的运动规划与VLA交错执行，无需额外训练即可提升长时程移动操控的鲁棒性。利用VLM进行完成检查并结合本体感知触发器实现模块切换。在BEHAVIOR-1K上任务进度提升113%。",
          "reasonCn": "旨在增强VLA模型的鲁棒性，直接处理视觉、语言、动作三要素。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "提出LEGS，利用具身高斯泼溅混合仿真器生成免遥操作的演示数据，微调VLA策略。在Unitree G1上执行三类拾放任务，仅用合成数据训练的模型匹配或超越人类遥操作数据训练。证明照片级渲染对合成数据迁移至关重要。",
          "reasonCn": "针对人形机器人运动操控训练VLA策略，使用视觉语言动作。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "提出OneVLA，统一架构同时输出导航与操控动作，通过多阶段渐进训练实现任务间正迁移。在模拟和真实环境中取得最优性能，超越单一任务和跨任务模型。代码和模型将公开。",
          "reasonCn": "构建统一VLA框架处理导航和操控，涉及视觉、语言指令和动作。",
          "lane": "VLA",
        ...
        },
        {
          ...
          "summaryCn": "提出想象力驱动机架ImagineUAV，通过潜视频扩散模型想象指令条件的未来观测，再抽取6-DoF动作。运动动力学规划器进一步优化轨迹，实现实时推理。在无人机视觉语言导航任务和实际飞行中性能领先。",
          "reasonCn": "结合世界模型预测未来观测和动作提取，同时处理视觉语言指令和飞行动作，兼具VLA和WAM。",
          "lane": "BOTH",
        ...
        },
        {
          ...
          "summaryCn": "提出拉格朗日扰动扩散引导（LP-DS），通过优化噪声空间扰动微调冻结的生成策略，结合信赖域目标平衡值提升与先验偏差。在机器人操控和运动任务上改善样本效率与成功率，适用于VLA模型和物理Franka平台。",
          "reasonCn": "方法直接用于微调大型视觉语言动作模型并部署到机器人，提升动作性能。",
          "lane": "VLA",
